...
public class AddNewProductActivity extends AppCompatActivity {
    ...
    private String CategoryName, Description, Contact, Pname, saveCurrentDate, saveCurrentTime;
    private Button AddNewProductButton;
    private ImageView InputProductImage;
    private EditText InputProductName, InputProductDescription, InputContact;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddNewProductButton = (Button) findViewById(R.id.button_post);
        InputProductImage = (ImageView) findViewById(R.id.product);
        InputProductName = (EditText) findViewById(R.id.pdt_name);
        InputProductDescription = (EditText) findViewById(R.id.pdt_desc);
        InputContact = (EditText) findViewById(R.id.pdt_contact);
    ...
    private void ValidateProductData()
    {
        ...
        {
            Toast.makeText(this, "Please give your contact information", Toast.LENGTH_SHORT).show();
        }
    ...
    private void StoreProductInformation() {
        ...
        loadingBar3.setTitle("Posting");
        loadingBar3.setMessage("Please wait, while the product is being posted.");
    ...
    private void SaveProductInfoToDatabase() {
        ...
        productMap.put("Conatct", Contact);
